...
std::vector<std::vector<std::vector<int>>> rebuildMatrix(int l, int r, int y, int x,
...
std::vector<std::vector<std::vector<int>>> deleteMatrix(int l, int r, int y, int x, std::vector<std::vector<std::vector<int>>> matrix);
